...
model = dict(
    ...
    backbone=dict(
        ...
        num_stages=4,
        out_indices = (0, 1, 2, 3),
        pretrained= "JDet/weights/lsk_s_backbone-e9d2e551_jittor.pkl"),
    neck=dict(
        type='FPN',
...
dataset = dict(
    train=dict(
        type="DOTADataset",
        dataset_dir='autodl-tmp/DOTA/processed_DOTA/trainval_1024_200_1.0',
        transforms=[
            dict(
                type="RotatedResize",
                min_size=1024,
    ...
    val=dict(
        type="DOTADataset",
        dataset_dir='autodl-tmp/DOTA/processed_DOTA/val_1024_200_1.0',
        transforms=[
            dict(
                type="RotatedResize",
                min_size=1024,
    ...
    test=dict(
        type="ImageDataset",
        images_dir='autodl-tmp/DOTA/processed_DOTA/test_1024_200_1.0/images',
        transforms=[
            dict(
                type="RotatedResize",
                min_size=1024,
...
log_interval = 50
work_dir = "autodl-tmp/work_dirs/lsk_s_my"